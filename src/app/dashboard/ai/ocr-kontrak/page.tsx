...
import { Upload, Loader2, FileText, ExternalLink, FilePlus, Image, Search } from 'lucide-react'; import { toast } from 'sonner'
...
export default function OcrKontrakPage() {
  ...
  useEffect(() => {
    ...
    apiFetch<OcrHistory[]>('/api/v1/ai/ocr-kontrak').then(r => setHistory(r.data ?? [])).catch(() => {}).finally(() => setHistoryLoading(false));
  }, []);
