        ...
        <div className="p-4 border-b border-[#c5c4db]/30">
          <div className="relative max-w-md">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-[#f2f4f6] border border-[#c5c4db]/50 rounded-full text-sm text-[#0F172A] caret-[#0F172A] focus:ring-2 focus:ring-[#1E40AF]/20 focus:border-[#1E40AF] outline-none transition-all font-[family-name:var(--font-body)]"
            />
          </div>
        </div>
